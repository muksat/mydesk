            ...
            <div class="field">
                ...
                <div class="ui mini input">   
                    ...
                    echo $form->dropDownList($model, 'item_id', CHtml::listData($packagelist, 'item', function($item) {
                            ...
                            }), array('class' => 'ui mini selection dropdown item_update', 'placeholder' => 'Select', 'empty' => '-Select-',
            ...
            <div class="field">
                ...
                <div class="ui mini input">
                    ...
                    echo $form->dropDownList($model, 'size', CHtml::ListData($sizelist, 'size', function($size) {
                            ...
                            }), array('class' => 'ui mini selection dropdown size_update', 'placeholder' => 'select', 'empty' => '-Select-'))
                    ?>                                                              
                </div>
            ...
            <div class="field">
                ...
                <div class="ui mini input">
                    ...
                    echo $form->dropDownList($model, 'color', CHtml::ListData($colorlist, 'color', function($color) {
                            ...
                            }), array('class' => 'ui mini selection dropdown', 'placeholder' => 'select', 'empty' => '-Select-'))
                    ?>   
