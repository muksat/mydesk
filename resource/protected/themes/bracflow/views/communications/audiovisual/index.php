...
<h3 class="ui dividing header" style="margin-top: 0" id='headerTop'>My Audiovisual Service Requests</h3>
    ...
    'columns' => array(
        ...
        array(
            ...
            'buttons' => array(
                'feedback' => array(
                    'label' => "Feedback",
                    'url' => 'Yii::app()->createUrl("//communications/default/feedback", array("id" => $data->id,"service"=>"audiovisual"))',
                    'visible' => 'TeamMembers::model()->isFeedbackGiven($data->id, "audiovisual")',
                    'options' => array(
