...
<b><font face="Default Sans Serif,Verdana,Arial,Helvetica,sans-serif" size="2">A new <?php echo $service; ?> service (id# <?php echo $model->id; ?>) has been requested.Click <?php echo CHtml::link('Inbox', Yii::app()->createAbsoluteUrl('communications/default/inbox'));?> to view details</font></b>
